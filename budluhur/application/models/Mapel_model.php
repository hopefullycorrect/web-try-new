...
class Mapel_model extends CI_Model {
    ...
    public function get_semesters_by_nis($nis) {
        ...
        return array_map(function($row) { return $row['semester']; }, $query->result_array());
    }
    ...
    function add($arg) {
        ...
        $this->db->insert('raport', $raport_data);
    }
    ...
    function delete($nis, $matapelajaran) {
        $this->db->where('nis', $nis);
        ...
        $this->db->where('nis', $nis);
        $this->db->where('matapelajaran', $matapelajaran);
        return $this->db->delete('raport');
    }

    public function count_unique_matapelajaran() {
        $this->db->distinct();
